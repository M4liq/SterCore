...
namespace leave_management.Migrations
{
    ...
    [Migration("20201017133318_CreatingNullableForeignKeysInLeaveAllocation")]
    partial class CreatingNullableForeignKeysInLeaveAllocation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("leave_management.Data.CommonLeaveTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("AssignedMonthly")
                        .HasColumnType("bit");

                    b.Property<bool>("AssignedYearly")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("leave_management.Data.ExplicitLeaveTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("leave_management.Data.LeaveRequests", b =>
                {
                    ...
                    b.HasOne("leave_management.Data.CommonLeaveTypes", "LeaveType")
                        .WithMany()
                        .HasForeignKey("LeaveTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
